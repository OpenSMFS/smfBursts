...
def check_channelset(val:Union[ChannelSet,Sequence[Union[bool,int]]], **kwargs)->ChannelSet:
    ...
    :class:`smfbursts.datamodel.immutabledata.TypeValidator` to check that
    ...
    **kwargs 
        ...
        :class:`smfbursts.datamodel.immutabledata.TypeValidator`
...
def read_channelset(group:tb.Group, dct:dict)->ChannelSet:
    ...
    :class:`smfbursts.datamodel.immutabledata.TypeValidator` to write 
    :class:`ChannelSet` to 
...
class PhSel:
    ...
    >>> aexdaem = smf.PhSel('1ex[0,1]em1pol')
    ...
    >>> dex_aexaem = smf.PhSel('0ex_1ex1em')
