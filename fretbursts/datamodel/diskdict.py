...
"""
This moduel supplies a way to make disk access and memory access to
dictionary-like objects essentially seemless.

The main class of this module is the :class:`DickDict` which uses the different
methods supplied by :class:`immutabledata.TypeValidator` objects to create a
representation of a dictionary inside of a HDF5-file. :class:`DickDict` and
...
from .utils import FixedDict, _dim_iter, ImDict, _GroupFuture, GroupFuture, GroupArg, _masked_iter
...
class DiskDict:
    """
    Abstract base class for group of objects that mimic behavior of dictionaries,
    ...
    _cache:dict
    _frozen:bool
    _autosave:Union[bool,Callable[[],bool]]
    ...
    def __init__(self, dct:Union[dict,None]=None, group:GroupFuture=None, 
                 autosave:Union[bool,Callable[[],bool]]=False):
    ...
    def _write_item(self, key, value, group:Union[tb.Group,None]=None)->None:
